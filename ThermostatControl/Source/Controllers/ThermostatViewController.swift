...
public class ThermostatViewController: UIViewController {
    ...
    public static func loadFromNib() -> ThermostatViewController {
        return Bundle.thermostatBundleHelper.instantiateViewController(targetClass: ThermostatViewController.self, nibName: "ThermostatViewController")
    }
    ...
    open override func viewDidLoad() {
        ...
        let selectedImage: UIImage? = Bundle.thermostatBundleHelper.image(named: "buttonSelected")
        let normalImage: UIImage? = Bundle.thermostatBundleHelper.image(named: "normalButton")
        ...
        heatingButton.setImage(Bundle.thermostatBundleHelper.image(named: "sun"), for: .normal)
        wateringButton.setImage(Bundle.thermostatBundleHelper.image(named: "water"), for: .normal)
        coolingButton.setImage(Bundle.thermostatBundleHelper.image(named: "snow"), for: .normal)
